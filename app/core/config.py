...
class Settings(BaseSettings):
    ...
    alipay_payment_enabled: bool = Field(default=False)
    alipay_gateway_url: str = Field(default="https://openapi.alipay.com/gateway.do")
    alipay_app_id: str = Field(default="")
    alipay_private_key: str = Field(default="")
    alipay_public_key: str = Field(default="")
    alipay_notify_url: str = Field(default="")
    alipay_return_url: str = Field(default="")
