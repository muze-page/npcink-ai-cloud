...
DOMAIN="${MAGICK_CLOUD_DOMAIN_NAME:-}"
LOCAL_CERT_PATH="${MAGICK_CLOUD_DOMAIN_CERT_PATH:-}"
LOCAL_KEY_PATH="${MAGICK_CLOUD_DOMAIN_KEY_PATH:-}"
REMOTE_CERT_DIR="${MAGICK_CLOUD_DOMAIN_REMOTE_CERT_DIR:-}"
UPSTREAM_URL="${MAGICK_CLOUD_DOMAIN_UPSTREAM_URL:-http://127.0.0.1:8010}"
