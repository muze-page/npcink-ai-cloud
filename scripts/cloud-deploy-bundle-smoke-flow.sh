...
export NPCINK_CLOUD_PORTAL_EMAIL_SMTP_HOST="${NPCINK_CLOUD_PORTAL_EMAIL_SMTP_HOST:-smtp.invalid}"
export NPCINK_CLOUD_PORTAL_EMAIL_FROM_EMAIL="${NPCINK_CLOUD_PORTAL_EMAIL_FROM_EMAIL:-noreply@magick.invalid}"
...
export NPCINK_CLOUD_PORTAL_PUBLIC_BASE_URL="${NPCINK_CLOUD_PORTAL_PUBLIC_BASE_URL:-${BASE_URL}}"
